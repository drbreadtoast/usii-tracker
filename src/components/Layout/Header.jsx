...
import { Clock, DollarSign, Newspaper, Droplet, Target, Receipt, MessageSquareQuote, Map, Flame, List, AlertOctagon, MessageCircle, Landmark, Fuel, Skull, Search, X, ChevronLeft, ChevronRight, LayoutGrid } from 'lucide-react'
  ...
  return (
    <>
      <header className="bg-gray-900 border-b border-gray-800 px-4 py-2 flex items-center justify-between shrink-0 relative">
        ...
        {/* Page Navigation */}
        <div className="relative flex items-center mx-2 sm:mx-4 min-w-0 flex-1">
          {canScrollLeft && (
            <button
              onClick={() => scrollNav(-1)}
