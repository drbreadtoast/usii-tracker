...
const NETANYAHU_CLAIMS = [
  { id: 'nc-01', year: 1992, date: '1992-01-20', claim: 'Iran will have nuclear weapons within 3 to 5 years, and must be stopped.', context: 'Statement as member of Knesset, Israeli parliament', source: 'Israeli media reports; AP wire; The Intercept timeline', sourceUrl: 'https://theintercept.com/2015/03/02/brief-history-netanyahu-crying-wolf-iranian-nuclear-bomb/', yearsAgo: 34, title: 'Member of Knesset' },
  { id: 'nc-02', year: 1995, date: '1995-01-01', claim: 'Iran is 3-5 years from producing a nuclear weapon. We cannot wait for the world to act.', context: 'Published in his book "Fighting Terrorism" (1995 edition)', source: '"Fighting Terrorism" by Benjamin Netanyahu, 1995', sourceUrl: 'https://books.google.com/books/about/Fighting_Terrorism.html?id=b5RAjkVq2voC', yearsAgo: 31, title: 'Member of Knesset, Likud Leader' },
  { id: 'nc-03', year: 1996, date: '1996-07-10', claim: 'If Iran is not stopped, it will have the bomb within 3-5 years.', context: 'Address to a joint session of the US Congress', source: 'Congressional Record, July 10, 1996', sourceUrl: 'https://www.c-span.org/program/joint-session-of-congress/israel-prime-minister-speech/57632', yearsAgo: 30, title: 'Prime Minister of Israel' },
  { id: 'nc-04', year: 2002, date: '2002-09-12', claim: 'Iran is developing nuclear weapons and will have them very soon.', context: 'Testimony to US Congress urging action against Iran', source: 'House Government Reform Committee testimony, Sep 12, 2002', sourceUrl: 'https://www.c-span.org/program/house-committee/israeli-perspective-on-conflict-with-iraq/125088', yearsAgo: 24, title: 'Former Prime Minister of Israel' },
  ...
  { id: 'nc-08', year: 2015, date: '2015-03-03', claim: 'This deal does not block Iran\'s path to the bomb — it paves it.', context: 'Unprecedented address to US Congress (without presidential invitation) opposing JCPOA nuclear deal', source: 'Congressional Record, Mar 3, 2015; C-SPAN', sourceUrl: 'https://www.c-span.org/program/public-affairs-event/israeli-prime-minister-address-to-joint-meeting-of-congress/643871', yearsAgo: 11, title: 'Prime Minister of Israel' },
  ...
  { id: 'nc-10', year: 2021, date: '2021-09-27', claim: 'Iran\'s nuclear weapons program is at a critical point. The world must act now or face a nuclear-armed Iran.', context: 'Public statement with satellite photos of alleged nuclear sites', source: 'Netanyahu statement, Sep 2021; Times of Israel', sourceUrl: 'https://www.timesofisrael.com/un-nuclear-watchdog-confirms-iran-enriching-uranium-at-natanz-to-60/', yearsAgo: 5, title: 'Leader of the Opposition' },
      ...
      {isOpen && (
        <div className="space-y-2">
          ...
          <div className="bg-gray-900/40 border border-gray-800 rounded-lg px-4 py-2.5 mt-3">
            <p className="text-[10px] text-gray-500 italic">
              <Shield size={10} className="inline mr-1 -mt-0.5" />
              All items above are based on publicly available statements and reporting. TheOSSreport.com presents documented facts alongside official claims
